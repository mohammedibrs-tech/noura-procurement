...
2) مورد واحد إضافي حقيقي بالسوق السعودي (غير الموردين المذكورين أعلاه) يستحق دعوته لتقديم عرض، مع اسمه وموقعه الإلكتروني إن وجد وبريده الإلكتروني إن كان متاحاً علناً.

مهم جداً: أجب بصيغة JSON صِرف فقط، بدون أي نص قبله أو بعده، بالشكل التالي بالضبط:
{"market_price_range":"...","suggested_vendor":{"name":"...","website":"...","email":"..."}}`;
